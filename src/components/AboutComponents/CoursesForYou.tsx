  ...
  const CommonComponent1 = ({ heading }: CommonComponentInterface) => {
    return (
      <div className=" w-[50%] py-8 px-[4rem]">
        <h1 className="font-body font-extrabold text-3xl tracking-wide ">{heading}</h1>
        ...
        <ul>
          <li className="flex items-center justify-start gap-3">
            <span className="material-symbols-outlined text-[#09AEFE]">radio_button_checked</span>
            <p className="text-lg font-heading font-light">Nullam in nulla fermentum,</p>
          </li>
          <li className="flex items-center justify-start gap-3 my-4">
            <span className="material-symbols-outlined text-[#09AEFE]">radio_button_checked</span>
            <p className="text-lg font-heading font-light">Efficitur erat vel, sodales massa.</p>
          </li>
          <li className="flex items-center justify-start gap-3 my-4">
            <span className="material-symbols-outlined text-[#09AEFE]">radio_button_checked</span>
            <p className="text-lg font-heading font-light">Phasellus quis quam auctor, mollis</p>
          </li>
          <li className="flex items-center justify-start gap-3 my-4">
            <span className="material-symbols-outlined text-[#09AEFE]">radio_button_checked</span>
          ...
          <li className="flex items-center justify-start gap-3 my-4">
            <span className="material-symbols-outlined text-[#09AEFE]">radio_button_checked</span>
            <p className="text-lg font-heading font-light">Cras molestie tortor in augue dictum</p>
          </li>
        </ul>
      </div>
    );
      ...
      case 1:
        return (
          <div className="flex w-full">
            {<CommonComponent1 heading={"The Prodigious eLearning Courses for you"} />}
          </div>
        );
      case 2:
        return (
          <div className="flex w-full">
            {<CommonComponent1 heading={"Lorem ipsum dolor sit, amet adipisicing, consectetur."} />}
          </div>
        );
      case 3:
        return (
          <div className="flex w-full">
            {<CommonComponent1 heading={"Commodi consequuntur hic dicta sed?"} />}
          </div>
        );
      case 4:
        return (
          <div className="flex w-full">
            {<CommonComponent1 heading={"Sequi tenetur dolores id doloribus officia."} />}
          </div>
        );
      default:
        return null;
      ...
      <div className=" w-[10%]">
        ...
        >
          ...
          <li
            ...
            onClick={() => setActive(4)}
          >
            <p className={`${styles.learningLink} ${active === 4 && styles.currentLink} `}>
