...
const CommonComponent1 = ({ inView }: { inView: boolean }) => {
  return (
    <div className=" py-5 px-24 w-[50%] text-left">
      ...
      <div className="my-6">
        ...
        <ul>
          ...
          >
            <img className="w-8 h-8 mr-5" src="icons/protractor.webp" alt="" />
            <span className="text-base font-light font-heading">
...
const CommonComponent2 = ({ path1, path2, inView }: Component2) => {
  return (
