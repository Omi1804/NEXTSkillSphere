...
const CoursesRecommendation = () => {
  ...
  return (
    <div ref={ref} className={`${!inView && "opacity-0"} opacity-100 duration-500`}>
      <div className="py-16 px-20 bg-[url('/violet-pista-curve.webp')] bg-[#fafafa] bg-no-repeat bg-center bg-cover grid gap-10 grid-cols-4 justify-items-center">
        ...
        >
          <div className="w-[4rem] h-[4rem] object-contain mb-8">
            <img src="/icons/tests-taken.webp" className="w-full h-full" alt="" />
          </div>
        ...
        >
          <div className="w-[4rem] h-[4rem] object-contain mb-8">
            <img src="/icons/student-genius.webp" className="w-full h-full" alt="" />
          </div>
        ...
        >
          ...
          <p className="font-body font-light text-base">ALL TRAINED PROFESSIONALS</p>
        </div>
      </div>
    </div>
  );
