    ...
    <div ref={ref} className="relative w-full border-b pb-[4rem]">
      ...
      <div>
        <div className=" py-16 text-center overflow-hidden">
          <h1 className="text-4xl font-extrabold mt-3 mb-5">A New Era in Online Education</h1>
          <p className="text-base font-extralight tracking-wider">CASE STUDIES FOR YOU</p>
        </div>
