    ...
    <div className="bg-[url(/cnt-info.webp)] bg-top bg-contain bg-no-repeat px-[4rem] py-[6rem] flex w-full h-full">
      <div className="w-[55%] px-[2rem]">
        ...
        <div className="flex gap-7">
          ...
          <p className="font-heading font-light tracking-wide text-md">09:00 hrs to 17:00 hrs</p>
        </div>
        <div className="flex gap-7">
          <h3 className="font-bold font-heading text-md tracking-wide text-[#22222]">
            SATURDAY & SUNDAY :
          </h3>
          <p className="font-heading font-light tracking-wide text-md">09:00 hrs to 14:00 hrs</p>
        </div>
      </div>
      <div className="w-[45%] py-[4rem]">
        <div className="flex m-6 ">
          <span className="material-symbols-outlined mx-2 ">location_on</span>
          <h3 className="font-bold font-heading text-base mx-2 w-[5.5rem]">ADDRESS :</h3>
        ...
        <div className="flex m-6 ">
          ...
          <h3 className="font-bold font-heading text-base mx-2 w-[5.5rem]">PHONE :</h3>
          <p className="font-heading font-light text-base mx-2">+3233-332-334</p>
        </div>
        <div className="flex m-6 ">
